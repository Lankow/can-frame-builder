...
public class SourceCodeGenerator(Settings settings)
{
    ...
    public void Generate(List<CANFrame> frames)
    {
        foreach (var frame in frames)
        {
            ...
            if (_settings.AddToProject)
            {
                ...
                {
                    AddFileToProject(project.CsProjectPath, filePath);
                }
            }
        }
    }
    ...
    private static string ExtractNonGeneratedBlock(string fileContent)
    {
    ...
    private static string CalculateNamespace(string solutionPath, string outputDirectory)
    {
    ...
    private static void AddFileToProject(string csprojPath, string filePath)
    {
